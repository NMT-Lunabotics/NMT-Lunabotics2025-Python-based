#!/usr/bin/env python3
from rclpy.qos import QoSProfile, DurabilityPolicy, QoSHistoryPolicy, QoSReliabilityPolicy
...
class CameraViewNode(Node):
    def __init__(self):
        ...
        self.qos=QoSProfile(reliability=QoSReliabilityPolicy.BEST_EFFORT,history=QoSHistoryPolicy.KEEP_LAST,depth=1,durability=DurabilityPolicy.VOLATILE)
        ...
        self.create_subscription(CompressedImage,self.image_topic,self.image_callback,self.qos)
