...
def generate_launch_description():
    ...
    camera_launch_file=os.path.join(camera_directory,'launch','usb_camera_launch_compressed.py')
    camera_config_file=os.path.join(system_start_directory,'config','cameras_compressed.yaml')
    ...
    return LaunchDescription([automated_operations,camera_launch, serial_talker_node])